...
protected:
    ...
    inline int32_t Response(
        HDI::Ril::V1_1::RilRadioResponseInfo &responseInfo, FuncType &&func, ParamTypes &&... args);
    template<typename FuncType, typename... ParamTypes>
    inline int32_t Notify(int32_t notifyType, const HRilErrNumber error, FuncType &&func, ParamTypes &&... args);
    ...
    ParamTypes &&... args)
{
    ...
    (callback->*(func))(BuildIHRilRadioResponseInfo(responseInfo), std::forward<ParamTypes>(args)...);
    return HRIL_ERR_SUCCESS;
}

template<typename FuncType, typename... ParamTypes>
inline int32_t HRilBase::Notify(int32_t notifyType, const HRilErrNumber error, FuncType &&func, ParamTypes &&... args)
{
    auto callback = GetRilCallback();
    if (callback == nullptr || func == nullptr) {
    ...
    (callback->*(func))(mResponseInfo, std::forward<ParamTypes>(args)...);
    return HRIL_ERR_SUCCESS;
}
} // namespace Telephony
} // namespace OHOS
