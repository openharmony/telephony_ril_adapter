...
inline const int32_t DC_MAX_SLOT_COUNT = 3;
...
public:
    ...
    int32_t Dial(int32_t slotId, int32_t serialId, const OHOS::HDI::Ril::V1_1::DialInfo &dialInfo);
    ...
    int32_t SendDtmf(int32_t slotId, int32_t serialId, const OHOS::HDI::Ril::V1_1::DtmfInfo &dtmfInfo);
    int32_t StartDtmf(int32_t slotId, int32_t serialId, const OHOS::HDI::Ril::V1_1::DtmfInfo &dtmfInfo);
    int32_t StopDtmf(int32_t slotId, int32_t serialId, const OHOS::HDI::Ril::V1_1::DtmfInfo &dtmfInfo);
    ...
    int32_t GetSimIO(int32_t slotId, int32_t serialId, const OHOS::HDI::Ril::V1_1::SimIoRequestInfo &simIO);
    int32_t GetSimStatus(int32_t slotId, int32_t serialId);
    int32_t GetImsi(int32_t slotId, int32_t serialId);
    int32_t GetSimLockStatus(int32_t slotId, int32_t serialId, const OHOS::HDI::Ril::V1_1::SimLockInfo &simLockInfo);
    int32_t SetSimLock(int32_t slotId, int32_t serialId, const OHOS::HDI::Ril::V1_1::SimLockInfo &simLockInfo);
    ...
    int32_t SetLocateUpdates(int32_t slotId, int32_t serialId, const HDI::Ril::V1_1::RilRegNotifyMode mode);
    ...
    int32_t SetNrOptionMode(int32_t slotId, int32_t serialId, int32_t mode);
    int32_t GetNrOptionMode(int32_t slotId, int32_t serialId);
    int32_t GetRrcConnectionState(int32_t slotId, int32_t serialId);
    int32_t GetNrSsbId(int32_t slotId, int32_t serialId);
    ...
    int32_t SetCBConfig(int32_t slotId, int32_t serialId, const OHOS::HDI::Ril::V1_1::CBConfigInfo &cellBroadcastInfo);
    ...
    int32_t SendSmsMoreMode(
        int32_t slotId, int32_t serialId, const OHOS::HDI::Ril::V1_1::GsmSmsMessageInfo &gsmSmsMessageInfo);
    int32_t SendSmsAck(int32_t slotId, int32_t serialId, const OHOS::HDI::Ril::V1_1::ModeData &modeData);
